...
import LeonnippLeonLeonnippLeonLeon from './leonnipp/leon/leonnipp.leon.leon'
...
export default { 
  ...
  LeonnippLeonLeonnippLeonLeon: load(LeonnippLeonLeonnippLeonLeon, 'leonnipp.leon.leon'),
